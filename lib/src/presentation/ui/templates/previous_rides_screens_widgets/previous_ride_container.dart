...
class PreviousRideContainer extends StatefulWidget {
  const PreviousRideContainer({Key? key}) : super(key: key);

  @override
  State<PreviousRideContainer> createState() => _PreviousRideContainerState();
}

class _PreviousRideContainerState extends State<PreviousRideContainer> {
  @override
