...
class SoloRideRatingScreen extends StatefulWidget {
  const SoloRideRatingScreen({Key? key}) : super(key: key);
  static const routeName = '/soloriderating-screen';

  @override
  State<SoloRideRatingScreen> createState() => _SoloRideRatingScreenState();
}

class _SoloRideRatingScreenState extends State<SoloRideRatingScreen> {
