...
class SoloRideWaitingScreen extends StatefulWidget {
  const SoloRideWaitingScreen({Key? key}) : super(key: key);
  static const routeName = '/soloridewaiting-screen';

  @override
  State<SoloRideWaitingScreen> createState() => _SoloRideWaitingScreenState();
}

class _SoloRideWaitingScreenState extends State<SoloRideWaitingScreen> {
  int currentIndex = -1;
      ...
      body: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .pushNamed(SoloRideInProgressAndFinishedScreen.routeName);
        },
        child: Stack(
